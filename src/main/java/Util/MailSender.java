...
public class MailSender {
	...
	public MailSender bcc(String bcc) {
		this.bcc.add(bcc);
		return this;
	}

	public MailSender personal(String personal) {
	...
	public MailSender context(String context) {
		this.context = context;
		return this;
	}

	public MailSender attachement(Path attachement) {
